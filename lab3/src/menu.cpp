...
{
	if(a1 < 0 || a2 < 0 || b1 < 0 || b2 < 0 || a1 > b1 || a2 > b2 || a1 >= tab->y || a2 >= tab->x || b1 >= tab->y || b2 >= tab->x)
	{
...
int processAnw(Tablica *tab, int odp)
	{
		...
		switch(odp)
		{
			...
			case 6:                                                           //6) Sumuj wiersz
				...
				cout << "Suma tego wiersza to: " << sumRow(*tab, a1) << endl;
				a1 = 0;
				break;
			case 7:                                                           //7) Sumuj kolumnę
				...
				cout << "Suma tej kolumny to: " << sumColumn(*tab, a1) << endl;
				a1 = 0;
				break;
			case 8:                                                           //8) Największa wartość w przedziale
				...
				cout << "Najwieksza wartosc to: " << largest(*tab, a1, a2, b1, b2) << endl;
				break;
			case 9:                                                           //9) Najmniejsza wartość w przedziale
				...
				cout << "Najmniejsza wartosc to: " << smallest(*tab, a1, a2, b1, b2) << endl;
				break;
			case 10:                                                          //10) Średnia z przedziału
				...
				cout << "Srednia wartosc to: " << average(*tab, a1, a2, b1, b2) << endl;
				break;
			case 11:                                                           //11) Zakończ
				return -1;
			default: 
